                        ...
                        <div className="col">
                            ...
                            <div className="cart_items">
                                ...
                                <li className="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
                                    ...
                                    <div><div className="product_image"><img src="images/cart_item_1.jpg" alt /></div></div>
                                    <div className="product_name_container">
                                        <div className="product_name"><a href="product.html">Cool Flufy Clothing without Stripes</a></div>
